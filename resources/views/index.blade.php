                ...
                <div class="content-wrapper">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="card">
                                    <img src="{{url('/')}}/assets/images/widgets/blog5.jpeg" class="card-img-top" alt="...">
                                    <div class="card-body">
                                ...
                                <div class="card widget widget-info">
                                    <div class="card-body">
                                        <div class="widget-info-container">
                                            <div class="widget-info-image" style="background: url('{{url('/')}}/assets/images/widgets/security.svg')"></div>
